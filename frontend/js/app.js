...
const showInstallingState = () => {
  installButton.innerHTML = '<span aria-hidden="true">↓</span> Installing...';
  installButton.setAttribute('aria-label', 'Installing MediaDrop');
